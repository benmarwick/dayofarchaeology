...
In the 2012-2013 corpus there are a total of 352,558 words in 622 blog posts by 370 unique authors. The author count is probably an underestimate as some posts are written by multiple people using a common affliation as the author name. There were fewer posts in 2013 (n = 273) compared to 2012 (n = 348), but the average length of the posts is slightly higher in 2013 (mean = 591) compared to 2012 (mean = 549). 
